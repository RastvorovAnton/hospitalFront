      ...
      {click === 0 ?
        <div className='reg-form'>
          ...
          <div className='reg-link'>
            <button disabled={!formValid} className="Registr" >Зарегистрироваться</button>
            <Link to='/authorization'>
              <span className='ButtonStyle' onClick={() => setClick(1)} >Авторизоваться</span>
            </Link>
          </div>
        </div>
        : click === 121331231
